...
*}
<section class="block tags_block {if !$is_stacked_footer} col-lg-{$blocktags_wide_on_footer} {/if}{if $hide_on_mobile == 1} hidden-md-down {elseif $hide_on_mobile == 2} st_open {/if}">
