...
{if $page['page_name'] != 'product'}
    ...
    <meta property="og:url" content="{if isset($url) && $url}{$url}{else}{$urls['current_url']}{/if}" />
    ...
    <meta property="og:title" content="{$page['meta']['title']}" />
    <meta property="og:description" content="{$page['meta']['description']}" />
    <meta property="og:image" content="{$urls['img_manu_url']}{$smarty.get.id_manufacturer}.jpg" />
    {elseif $page['page_name']=='supplier' && isset($smarty.get.id_supplier) && $smarty.get.id_supplier}
    <meta property="og:type" content="product" />
    <meta property="og:title" content="{$page['meta']['title']}" />
    <meta property="og:description" content="{$page['meta']['description']}" />
    <meta property="og:image" content="{$urls['img_sup_url']}{$smarty.get.id_supplier}.jpg" />
    {elseif $page['page_name']=='module-stblog-article'}
    <meta property="og:type" content="article" />
    <meta property="og:title" content="{$meta_title}" />
    <meta property="og:description" content="{$meta_description}" />
    <meta property="og:image" content="{$blog_image_link}" />
    {elseif $page['page_name']=='module-stproductcomments-list'}
    <meta property="og:type" content="product" />
    <meta property="og:title" content="{$meta_title}" />
    <meta property="og:description" content="{$meta_description}" />
    <meta property="og:image" content="{$image_link}" />
...
<style>{$custom_css nofilter}</style>
{/if}