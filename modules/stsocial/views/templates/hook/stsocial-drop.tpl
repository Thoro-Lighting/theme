...
<div class="top_bar_item dropdown_wrap pro_right_item">
    <div class="dropdown_tri dropdown_tri_in header_item {if isset($classname)} {$classname} {/if}">
        {if $social_label==0 || $social_label==2}<i class="fto-us icon_btn {if $social_label==0} mar_r4 {/if}"></i>{/if}{if $social_label==0 || $social_label==1}{l s='Share' d='Shop.Theme.Transformer'}{/if}<i class="fto-angle-down arrow_down arrow"></i><i class="fto-angle-up arrow_up arrow"></i>
    </div>
