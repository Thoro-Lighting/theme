...
{if $sttheme.flyout_share && isset($stsocial) && $stsocial}
	<div class="hover_fly_btn social_share_button" title="{l s='Share on social networks' d='Shop.Theme.Transformer'}">
		...
		<div class="hover_fly_btn_inner"><i class="fto-us icon_btn"></i><span>{l s='Share' d='Shop.Theme.Transformer'}</span></div>
	</div>
{/if}