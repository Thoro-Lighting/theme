...
<section class="{if !isset($is_stacked_footer) || !$is_stacked_footer}col-lg-{if $wide_on_footer}{$wide_on_footer}{else}3{/if}{/if} block footer_block{if $hide_on_mobile == 1} hidden-md-down {elseif $hide_on_mobile == 2} st_open {/if}">
