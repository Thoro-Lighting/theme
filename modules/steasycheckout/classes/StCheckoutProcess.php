...
class StCheckoutProcess implements RenderableInterface
{
    private $smarty;
    ...
    public function __construct(
        Context $context,
        StCheckoutSession $checkoutSession
    ) {
    ...
    public function addStep(StCheckoutStepInterface $step, $name=null)
    {
    ...
    public function getSteps($name=null)
    {
        if($name!==null)
            ...
            if (array_key_exists($id, $data)) {
                ...
                $step
                    ...
                    /*
                        iWeb - 2018-12-29
                    */
                    ->restorePersistedData($stepData, $data)
                ;
            }
        }
