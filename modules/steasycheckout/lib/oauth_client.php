...
*/
	Function Initialize()
	{
		...
		switch($this->server)
		{
			...
			default:
				if(!($json = @file_get_contents(dirname(__FILE__).DIRECTORY_SEPARATOR.$this->configuration_file)))
				{
					if(!file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR.$this->configuration_file))
