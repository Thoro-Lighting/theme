...
<li id="comment-{$node.id_st_blog_comment}" class="line_item">
	<div class="comment_node general_bottom_border clearfix py-md-5">
        ...
        <div class="comment_node_right">
            <p class="comment_node_info">
                ...
                {if $reply_ready}<a href="javascript:;" class="comment_reply_link btn-line-under" data-id-st-blog-comment="{$node.id_st_blog_comment}">{l s='Reply' d='Shop.Theme.Transformer'}</a>{/if}
            </p>
            {$node.content|nl2br}
        </div>
    </div>
