...
class StBlogComments extends Module
{
    ...
    public function hookActionDeleteGDPRCustomer($customer)
    {
        if (!empty($customer['id_customer'])) {
            $sql = "DELETE FROM "._DB_PREFIX_."st_blog_comment WHERE id_customer = '".(int)$customer['id_customer']."'";
    ...
    {
        if (!Tools::isEmpty($customer['id_customer'])) {
            $sql = "SELECT * FROM "._DB_PREFIX_."st_blog_comment WHERE id_customer = '".(int)$customer['id_customer']."'";
