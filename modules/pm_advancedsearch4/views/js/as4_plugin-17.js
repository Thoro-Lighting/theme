...
var as4Plugin = {
    ...
    showAsResponse: function(responseText, statusText, xhr, $form) {
        ...
        if (!responseText.without_products) {
            ...
            $('#side_facets .close_right_side').trigger('click');
        }
        ...
        jQuery('body').removeClass('loading-products');
    },
    ...
    initSearchEngine: function() {
        ...
        $(document).on('click', '.PM_ASBlockOutput .PM_ASResetAll', function(e) {
            e.preventDefault();

            id_search = as4Plugin.getIdSearchFromItem(this);
            search_method = as4Plugin.getParamValue(id_search, 'searchMethod');

            $('#PM_ASForm_' + id_search + '').append('<input type="hidden" name="reset" value="1">');

            as4Plugin.nextStep(id_search, 1); // 4
        });

        $(document).on('click', '.PM_ASCriterionsGroupTitle .openfiltr', function(e) {
            e.preventDefault();
            jQuery(this).parents('.PM_ASCriterionsGroupTitle').toggleClass('open');
        });
