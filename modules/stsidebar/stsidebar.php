        ...
        $this->_location = array(
                        ...
                        5=>array(
                         ...
                         6=>array(
                            'id' => 'location_6',
                            'value' => 6,
                            'label' => $this->getTranslatOr()->trans('Top of page', array(), 'Admin.Theme.Transformer'),
                            'direction' => 1,
                        ),
                         ...
                         7=>array(
                            'id' => 'location_7',
                            'value' => 7,
                            'label' => $this->getTranslatOr()->trans('Topbar left', array(), 'Admin.Theme.Transformer'),
                            'direction' => 1,
                        ),
                        ...
                        8=>array(
                            'id' => 'location_8',
                            'value' => 8,
                            'label' => $this->getTranslatOr()->trans('Topbar center', array(), 'Admin.Theme.Transformer'),
                            'direction' => 1,
                        ),
                        ...
                        9=>array(
                            'id' => 'location_9',
                            'value' => 9,
                            'label' => $this->getTranslatOr()->trans('Topbar right', array(), 'Admin.Theme.Transformer'),
                            'direction' => 1,
                        ),
                        10=>array(
                            'id' => 'location_10',
                            'value' => 10,
                            'label' => $this->getTranslatOr()->trans('Topbar left blog - displayNav1', array(), 'Admin.Theme.Transformer'),
                            'direction' => 1,
                        ),
                        ...
                        11=>array(
                            'id' => 'location_11',
                            'value' => 11,
                            'label' => $this->getTranslatOr()->trans('Topbar center blog - displayNav3', array(), 'Admin.Theme.Transformer'),
                            'direction' => 1,
                        ),
                        ...
                        12=>array(
                            'id' => 'location_12',
                            'value' => 12,
                            'label' => $this->getTranslatOr()->trans('Topbar right blog - displayNav2', array(), 'Admin.Theme.Transformer'),
                            'direction' => 1,
                        ),
                        ...
                        13=>array(
                            'id' => 'location_13',
                            'value' => 13,
                            'label' => $this->getTranslatOr()->trans('Top of page blog', array(), 'Admin.Theme.Transformer'),
                            'direction' => 1,
                        ),
...
private function initNativeModules()
    {
        $this->_native_modules = array(
            ...
            2 => array('name' => $this->getTranslator()->trans('Phone mobile', array(), 'Modules.Stsidebar.Admin'), 'module' => ''),
            ...
            18 => array('name' => $this->getTranslator()->trans('Product Comparison', array(), 'Admin.Theme.Transformer'), 'module' => 'stcompare'),
            13 => array('name' => $this->getTranslator()->trans('Wishlist', array(), 'Modules.Stsidebar.Admin'), 'module' => 'stwishlist'),
            16 => array('name' => $this->getTranslator()->trans('Change of currency and language', array(), 'Modules.Stsidebar.Admin'), 'module' => ''),
            14 => array('name' => $this->getTranslator()->trans('Login/register module with pull-out sidebar box', array(), 'Modules.Stsidebar.Admin'),'module' => 'stcustomersignin'),
            15 => array('name' => $this->getTranslator()->trans('Login/register link', array(), 'Modules.Stsidebar.Admin'),'module' => ''),
            ...
            17 => array('name' => $this->getTranslator()->trans('Extendable beam with basket option on the product card', array(), 'Admin.Theme.Transformer')),
              );
    }
    
     public static $classpluslink = array(
        1 => array('id' =>1, 'name' => 'Class 1'),
        2 => array('id' =>2, 'name' => 'Class 2'),
        3 => array('id' =>3, 'name' => 'Class 3'),
        4 => array('id' =>4, 'name' => 'Class 4'),
        5 => array('id' =>5, 'name' => 'Class 5'),
	...
	public function install()
	{
        $res = parent::install() &&
            ...
            $this->registerHook('displayTopBlog') &&
            $this->registerHook('displayNav1') &&
            $this->registerHook('displayNav2') &&
            $this->registerHook('displayNav3') &&
            $this->registerHook('displayNav1blog') &&
            $this->registerHook('displayNav2blog') &&
            $this->registerHook('displayNav3blog') &&
            ...
            Configuration::updateValue($this->_prefix_st.'HIDE_SIDEBAR_MOBILE', 0) &&
            Configuration::updateValue($this->_prefix_st.'BEAM_OPTION', 0) &&
            Configuration::updateValue($this->_prefix_st.'BEAM_OPTION_POSITION', 0) &&
            Configuration::updateValue($this->_prefix_st.'BEAM_OPTION_WIDTH', 0) &&
            Configuration::updateValue($this->_prefix_st.'BEAM_OPTION_NAME', 0) &&
            Configuration::updateValue($this->_prefix_st.'BEAM_OPTION_IMG', 1) &&
            Configuration::updateValue($this->_prefix_st.'BEAM_OPTION_PRICE', 0) &&
            Configuration::updateValue($this->_prefix_st.'BEAM_OPTION_QUANTITY', 1) &&
            Configuration::updateValue($this->_prefix_st.'BEAM_OPTION_BUTTON_STYLE', 1) &&
            Configuration::updateValue($this->_prefix_st.'BEAM_OPTION_BUTTON_MOB_STYLE', 1) &&
            Configuration::updateValue($this->_prefix_st.'BEAM_OPTION_ANIMATION', 0) &&
            Configuration::updateValue($this->_prefix_st.'BEAM_OPTION_QUICKBUY', 1) &&
    ...
    public function installDB()
    {
        $return = (bool)Db::getInstance()->execute('
            CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'st_sidebar` (
                ...
                `show_ammount` tinyint(1) unsigned NOT NULL DEFAULT 0, 
                `border_hover` tinyint(1) unsigned NOT NULL DEFAULT 0, 
                `direction` tinyint(1) unsigned NOT NULL DEFAULT 0, 
                `hide_on_mobile` tinyint(1) unsigned NOT NULL DEFAULT 0,
                
                `active` tinyint(1) unsigned NOT NULL DEFAULT 1, 
                `position` int(10) unsigned NOT NULL DEFAULT 0,
                `mobile_element` tinyint(1) unsigned NOT NULL DEFAULT 0,
        ...
        $return &= Db::getInstance()->execute('
            CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'st_sidebar_lang` (
                ...
                `titlesecond` varchar(255) DEFAULT NULL,
    ...
    public function getContent()
    {
        ...
        $this->registerHook('displayBeforeBodyClosingTag');
        $this->registerHook('displaySideBarCheckout');
    ...
    {        
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
              ...
              /*  array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Second title:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'titlesecond',
                    'lang' => true,
                    'size' => 64,
                 'desc' => $this->gettranslator()->trans('It works when the field named title is completed.', array(), 'Admin.Theme.Transformer'),
                ...
                array(
                       ...
                       array(
                        ...
                        array(
                         ...
                         array(
                            'id' => 'show_title_11',
                            'value' => 11,
                            'label' => $this->getTranslator()->trans('No - in topbar', array(), 'Admin.Theme.Transformer')),
                          
                          
                          array(
                            'id' => 'show_title_12',
                            'value' => 12,
                            'label' => $this->getTranslator()->trans('No desktop screen width > 992px', array(), 'Admin.Theme.Transformer')),
                        
                          
                          array(
                            'id' => 'show_title_13',
                            'value' => 13,
                            'label' => $this->getTranslator()->trans('No mobile screen width < 991px', array(), 'Admin.Theme.Transformer')),
                          
                          array(
                            'id' => 'show_title_14',
                            'value' => 14,
                            'label' => $this->getTranslator()->trans('No in all screen width - left or right zone', array(), 'Admin.Theme.Transformer')),
                          ),
                          
                        
                   'desc' => $this->gettranslator()->trans('Choice option when we select the show in option as: Header, Topbar left, Topbar center, Topbar right.', array(), 'Modules.Stsidebar.Admin'),
                 ...
                 array(
                    'type' => 'switch',
                    'label' => $this->getTranslator()->trans('Czy element ma ukrywać w wersji mobilnej dolną strefę z ikonami przy wysuniętym sidebarze:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'sidebar_off',
                    'is_bool' => true,
                    'default_value' => 1,
                    'values' => array(
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->getTranslator()->trans('Window as a drop down list:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'dropdown_list',
                    'is_bool' => true,
                    'default_value' => 0,
                    'values' => array(
                        ...
                        array(
                            'id' => 'dropdown_list_off',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Disabled', array(), 'Admin.Theme.Transformer')
                        )
                    ),
                 'desc' => $this->getTranslator()->trans('Only applies to the "Own content" window type.<br>Selecting this option will present the window as a drop-down list - dropdwon window.', array(), 'Admin.Theme.Transformer'),
                ),
                
                 array(
                    'type' => 'select',
                    'label' => $this->getTranslator()->trans('Add class:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'classpluslink',
                    'options' => array(
                        'query' => self::$classpluslink,
                        'id' => 'id',
                        'name' => 'name',
                        'default' => array(
                            'value' => 0,
                       ...
                       'desc' => $this->getTranslator()->trans('Only applies to the "Own content" window type.', array(), 'Admin.Theme.Transformer'),
             ),
                
                      array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Show ammount:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'show_ammount',
                    'default_value' => 0,
                    'values' => array(
                        array(
                        ...
                        array(
                            'id' => 'show_ammount_1',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Yes, in parentheses', array(), 'Admin.Theme.Transformer')),
                        array(
                            'id' => 'show_ammount_2',
                            'value' => 2,
                            'label' => $this->getTranslator()->trans('Yes, over the icon', array(), 'Admin.Theme.Transformer')),
                               ), 
                   'desc' => $this->gettranslator()->trans('Works only for modules that show the number of products, e.g. in a cart, recently viewed.', array(), 'Modules.Stsidebar.Admin'),
        ...
        $this->fields_form[0]['form']['input'][] = array(
          ...
          $this->fields_form[2]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Mobile navigation settings', array(), 'Modules.Stsidebar.Admin'),
                'icon'  => 'icon-cogs'
            ),
            'input' => array( 
              ...
              array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Settings of the mobile navigation system:', array(), 'Modules.Stsidebar.Admin'),
                    'name' => 'mobile_element',
                    'default_value' => 0,
                    'values' => array(
                        array(
                            'id' => 'mobile_element_5',
                            'value' => 5,
                            'label' => $this->getTranslator()->trans('No', array(), 'Modules.Stsidebar.Admin')),
                        array(
                            'id' => 'mobile_element_1',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('1 element', array(), 'Modules.Stsidebar.Admin')),
                        array(
                            'id' => 'mobile_element_2',
                            'value' => 2,
                            'label' => $this->getTranslator()->trans('2 element', array(), 'Modules.Stsidebar.Admin')),
                         array(
                            'id' => 'mobile_element_3',
                            'value' => 3,
                            'label' => $this->getTranslator()->trans('3 element', array(), 'Modules.Stsidebar.Admin')),
                          array(
                            'id' => 'mobile_element_4',
                            'value' => 4,
                            'label' => $this->getTranslator()->trans('Only account', array(), 'Modules.Stsidebar.Admin')),
                               ),
                                
                   'desc' => $this->gettranslator()->trans('These settings work only for the Navigate Module option.', array(), 'Modules.Stsidebar.Admin'),
    ...
    public function initFieldsForm()
    {
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->getTranslator()->trans('The standing beam option with a basket on the product card:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'beam_option',
                    'default_value' => 1,
                    'values' => array(
                        array(
                    ...
                    'validation' => 'isUnsignedInt',
                    'desc' => $this->getTranslator()->trans('If this option is enabled, an additional bar will appear on the product card after driving below the shopping cart zone with the option of adding the product to the shopping cart. Kleint will be able to add the product to the cart at any time.', array(), 'Admin.Theme.Transformer'),
                ),
                
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Zone width:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'beam_option_width',
                    'default_value' => 0,
                    'values' => array(
                        array(
                            'id' => 'beam_option_width_0',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Store width', array(), 'Admin.Theme.Transformer')),
                        array(
                            'id' => 'beam_option_width_1',
                            'value' => 1,
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Position:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'beam_option_position',
                    'default_value' => 0,
                    'values' => array(
                
                        array(
                            'id' => 'beam_option_position_1',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Top', array(), 'Admin.Theme.Transformer')),
                        array(
                            'id' => 'beam_option_position_0',
                            'value' => 0,
                ...
                array(
                    ...
                    'name' => 'beam_option_name',
                    'is_bool' => true,
                    'default_value' => 1,
                    'values' => array(
                        array(
                            'id' => 'beam_option_name_on',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Enabled', array(), 'Admin.Theme.Transformer')
                        ),
                        array(
                            'id' => 'beam_option_name_off',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Disabled', array(), 'Admin.Theme.Transformer')
                        )
                    ),
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->getTranslator()->trans('Product image visibility:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'beam_option_img',
                    'is_bool' => true,
                    'default_value' => 1,
                    'values' => array(
                        array(
                            'id' => 'beam_option_img_on',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Enabled', array(), 'Admin.Theme.Transformer')
                        ),
                        array(
                            'id' => 'beam_option_img_off',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Disabled', array(), 'Admin.Theme.Transformer')
                        )
                    ),
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Price visibility:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'beam_option_price',
                    'default_value' => 0,
                    'values' => array(
                        array(
                            'id' => 'beam_option_price_0',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Same as in the product card settings', array(), 'Admin.Theme.Transformer')),
                        array(
                            'id' => 'beam_option_price_1',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Only one price', array(), 'Admin.Theme.Transformer')),
                        array(
                            'id' => 'beam_option_price_2',
                            'value' => 2,
                            'label' => $this->getTranslator()->trans('Do not show', array(), 'Admin.Theme.Transformer')),
                   ),
                 ...
                 array(
                    'type' => 'switch',
                    'label' => $this->getTranslator()->trans('Quantity in stock:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'beam_option_quantity',
                    'is_bool' => true,
                    'default_value' => 0,
                    'values' => array(
                        array(
                            'id' => 'beam_option_quantity_on',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Enabled', array(), 'Admin.Theme.Transformer')
                        ),
                        array(
                            'id' => 'beam_option_quantity_off',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Disabled', array(), 'Admin.Theme.Transformer')
                        )
                    ),
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Button style for the basket:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'beam_option_button_style',
                    'default_value' => 0,
                    'values' => array(
                        array(
                            'id' => 'beam_option_button_style_0',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('The same as the main setting in the product', array(), 'Admin.Theme.Transformer')),
                        array(
                            'id' => 'beam_option_button_style_1',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Icon only', array(), 'Admin.Theme.Transformer')),
                        array(
                            'id' => 'beam_option_button_style_2',
                            'value' => 2,
                            'label' => $this->getTranslator()->trans('Text only', array(), 'Admin.Theme.Transformer')),
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->getTranslator()->trans('Will show a quick shopping button:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'beam_option_quickbuy',
                    'is_bool' => true,
                    'default_value' => 0,
                    'values' => array(
                        array(
                            'id' => 'beam_option_quickbuy_on',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Enabled', array(), 'Admin.Theme.Transformer')
                        ),
                        array(
                            'id' => 'beam_option_quickbuy_off',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Disabled', array(), 'Admin.Theme.Transformer')
                        )
                    ),
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Button style for the basket in simplified version:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'beam_option_button_mob_style',
                    'default_value' => 0,
                    'values' => array(
                        array(
                            'id' => 'beam_option_button_mob_style_0',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Icon and content', array(), 'Admin.Theme.Transformer')),
                        array(
                            'id' => 'beam_option_button_mob_style_1',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Text only', array(), 'Admin.Theme.Transformer')),
                 ...
                 array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('A simplified version - animation for the zone with a button to the cart:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'beam_option_animation',
                    'default_value' => 0,
                    'values' => array(
                        array(
                            'id' => 'beam_option_animation_0',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Full option', array(), 'Admin.Theme.Transformer')),
                        array(
                            'id' => 'beam_option_animation_1',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Transfer to the zone with the basket option', array(), 'Admin.Theme.Transformer')),
            ...
            array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Beam option in the mobile version:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'hide_sidebar_mobile',
                    'default_value' => 1,
                    'values' => array(
            
                       array(
                            'id' => 'hide_sidebar_mobile_on',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Dont display at all', array(), 'Admin.Theme.Transformer')
                        ),
                        array(
                            'id' => 'hide_sidebar_mobile_off',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Like the sidebar option', array(), 'Admin.Theme.Transformer')
                        ),
                                               
                        array(
                            'id' => 'hide_sidebar_mobile_2',
                            'value' => 2,
                            'label' => $this->getTranslator()->trans('As a separate beam with a hidden sidebar zone', array(), 'Admin.Theme.Transformer')
                        )
                    ),
                    'validation' => 'isUnsignedInt',
                      ),
    ...
    private function getConfigFieldsValues()
    {
        $fields_values = array(
            ...
            'hide_sidebar_mobile'                => Configuration::get($this->_prefix_st.'HIDE_SIDEBAR_MOBILE'),
            'beam_option'                => Configuration::get($this->_prefix_st.'BEAM_OPTION'),
            'beam_option_width'                => Configuration::get($this->_prefix_st.'BEAM_OPTION_WIDTH'),
            'beam_option_name'                => Configuration::get($this->_prefix_st.'BEAM_OPTION_NAME'),
            'beam_option_position'                => Configuration::get($this->_prefix_st.'BEAM_OPTION_POSITION'),
            'beam_option_img'                => Configuration::get($this->_prefix_st.'BEAM_OPTION_IMG'),
            'beam_option_price'                => Configuration::get($this->_prefix_st.'BEAM_OPTION_PRICE'),
            'beam_option_quantity'                => Configuration::get($this->_prefix_st.'BEAM_OPTION_QUANTITY'),
            'beam_option_button_style'                => Configuration::get($this->_prefix_st.'BEAM_OPTION_BUTTON_STYLE'),
            'beam_option_button_mob_style'                => Configuration::get($this->_prefix_st.'BEAM_OPTION_BUTTON_MOB_STYLE'),
            'beam_option_animation'                => Configuration::get($this->_prefix_st.'BEAM_OPTION_ANIMATION'),
            'beam_option_quickbuy'                => Configuration::get($this->_prefix_st.'BEAM_OPTION_QUICKBUY'),
    ...
    {        
        ...
        {   
            ...
            foreach ($sidebar_items as $v) {
                ...
                {
                    if($v['btn_color'])
                        $custom_css .= $classname.'.icone_top .header_item, '.$classname.'.icone_top {color:'.$v['btn_color'].'}';
                    if($v['btn_bg'])
                        $custom_css .= $classname.'.icone_top{background-color:'.$v['btn_bg'].'}';
                    if($v['btn_hover_color'])
                        $custom_css .= $classname.'.icone_top:hover .mobile_bar_tri_text, '.$classname.'.icone_top:hover .header_item, '.$classname.'.mobile_bar_item.active{color:'.$v['btn_hover_color'].'}';
                    if($v['btn_hover_bg'])
                        $custom_css .= $classname.'.icone_top:hover, '.$classname.'.mobile_bar_item.active{background-color:'.$v['btn_hover_bg'].'}';
                }
                else
                {
                    if($v['btn_color'])
                        $custom_css .= $classname.' .icon_wrap, '.$classname.'.icone_top{color:'.$v['btn_color'].'}';
                    if($v['btn_bg'])
    ...
    public function _prepare_bar($bar){
        ...
        */
        ...
        {
            $products_loved_nbr = StLovedProductClass::getMyLovedCount($this->context->customer->id, $this->context->customer->id_guest);
   ...
   public function hookdisplayTop($params){
        return $this->hookDisplayMobileBar($params, 6);
    }
    
  public function hookdisplayTopBlog($params){
        return $this->hookDisplayMobileBar($params, 13);
        
        
    }
    
public function hookdisplaySideBarCheckout($params){
        return $this->hookDisplaySideBar($params);
    }
    
 public function hookdisplayNav1($params){
        return $this->hookDisplayMobileBar($params, 7);
    }
    
    
    
 public function hookdisplayNav3($params){
        return $this->hookDisplayMobileBar($params, 8);
    }
    
 public function hookdisplayNav2($params){
        return $this->hookDisplayMobileBar($params, 9);
    }
    
    
 public function hookdisplayNav1blog($params){
        return $this->hookDisplayMobileBar($params, 10);
    }
    
    
    
 public function hookdisplayNav3blog($params){
        return $this->hookDisplayMobileBar($params, 11);
    }
    
 public function hookdisplayNav2blog($params){
        return $this->hookDisplayMobileBar($params, 12);
    }
    ...
    public function hookDisplaySideBar($params)
    {
        ...
        foreach ($sidebar_items as $k=>$v) {
            if($v['native_modules'] && $v['native_modules']!=7 && $v['native_modules']!=16)
