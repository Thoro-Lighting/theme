...
<ul id="multilink_mobile_{$link_group.id_st_multi_link_group}" class="{if $link_group.classplus != 1}mobile_stlinkgroups_plus_{$link_group.classplus}{/if} mo_mu_level_0 mobile_menu_ul">
