...
<div id="crossselling_products_container" class="crossselling_products_container block products_container {if $sttheme.position_buttons_cross}position_buttons_2{/if}">
<section class="products_section" >
    ...
    <div class="title_block flex_container title_align_{(int)$sttheme.cs_title} title_style_{(int)$sttheme.heading_style}">
        ...
        <div class="title_block_inner">{l s='Customers who bought this product also bought' d='Shop.Theme.Transformer'}</div>
