...
class StBlogTags extends Module
{
	...
	public function install()
	{
		if (!parent::install() 
			...
			|| !$this->registerHook('displayFooterTopBlog')
			|| !Configuration::updateValue('ST_BLOG_TAGS_NBR', 4)
			|| !Configuration::updateValue('ST_BLOG_TAGS_TITLE_ALIGN', 0)
			|| !Configuration::updateValue('ST_BLOG_TAGS_ALIGN', 0)
		...
		$this->fields_form[0]['form'] = array(
            ...
            'input' => array(
			 ...
			 array(
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Tags align:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'tags_align',
                    'default_value' => 0,
                    'values' => array(
                        array(
    ...
    public function hookDisplayFooterTopBlog($params)
{
		...
		return $this->display(__FILE__, 'stblogtags-footer.tpl');
	}
    ...
    private function getConfigFieldsValues()
    {
        $fields_values = array(
            ...
            'tags_title_align' => Configuration::get('ST_BLOG_TAGS_TITLE_ALIGN'),
            'tags_align' => Configuration::get('ST_BLOG_TAGS_ALIGN'),
        );
