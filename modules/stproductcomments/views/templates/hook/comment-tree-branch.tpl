...
<div id="pcomment-{$node.id_st_product_comment}" class="line_item general_top_border pt-4 pb-3">
	
    <div class="flex_container flex_column_md flex_start pcomment-for-reply" {if $pcomments.g_rich_snippets} itemprop="review" itemscope itemtype="https://schema.org/Review"{/if}>
        <div class="pcomment_left">
            ...
            <div class="pcomment_author font-weight-bold pcomment_left_item mt-3 mb-1 m-lg-0" {if $pcomments.g_rich_snippets} itemprop="author"{/if}>{$node.customer_name}</div>
             <span class="date-add txt-small">
        ...
        <div class="pcomment_right flex_child">
            ...
            <div class="mt-2">
                <div class="pcomment_rbl flex_child mb-2 txt-small">
                    ...
                    {else}
                        <a class="pcomment_product_name mr-2 font-weight-bold hidden-xs-down hidden-sm-up" href="{$node.product_link}" title="{$node.product_name_full}">{$node.product_name_full}</a>
                    {/if}
                    {if !isset($node.customer_report) || !$node.customer_report}
                    <a href="javascript:;" class="report_btn btn-spin js-btn-active mr-2 float-lg-right btn-line-under" data-id-st-product-comment="{$node.id_st_product_comment}" title="{l s='Report abuse' d='Shop.Theme.Transformer'}" rel="nofollow">{l s='Report abuse' d='Shop.Theme.Transformer'}</a>
                    {/if}                    
                    {/if}
                ...
                <div class="pcomment_rbr mb-1 txt-small">
