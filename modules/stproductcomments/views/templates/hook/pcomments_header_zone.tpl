...
<div class="pcomments_header">
   ...
   <!-- 
    ...
    <div class="pcomments_write flex_box flex_left">{if $can_comment}{include file='module:stproductcomments/views/templates/hook/pcomments_write_button.tpl' classname="ml-2"}{/if}</div>    
