...
{block name="page_content"}
  <h6 class="page_heading">{l s='Add a review' d='Shop.Theme.Transformer'}</h6>

<section id="st_product_comment_reply_block" class="block account_box_bg">
	<article>
    <div class="flex_container flex_start mb-3 row">
    ...
    {else}
	  <div class="st_product_comment_reply">
        ...
        {foreach from=$criterions item='criterion'}
          <li class="flex_left col-md-6">
            <label class="criterion_name col-md-6 re_label">{$criterion.name}:</label>
            <div class="star_content clearfix col-md-6">
			...
			{/if}
            <div class="form-group row mb-3 re_row">
              <label class="col-md-2 form-control-label required re_label">
              ...
              <div class="col-md-8 tag-wrap">
                ...
                <div class="charleft">{l s='Describe this product using simple and short words.' d='Shop.Theme.Transformer'}</div>
              </div>
            </div>
            
            <div class="form-group row re_row">
              <label class="col-md-2 form-control-label re_label">
            ...
            <div class="form-group row re_row">
              <div class="col-md-2 "><label class="re_label">{l s='Upload images:' d='Shop.Theme.Transformer'}</label></div>
              <div class="col-md-8 ">
                ...
                <div><br>
                    <input type="submit" name="st_product_comment_submit" id="st_product_comment_submit" value="{l s='Post comment' d='Shop.Theme.Transformer'}" class="btn btn-default benabled mar_r4" />
...
{block name='my_account_links'}
  <div class="clearfix my_account_page_footer mt-3 mb-3">
    <a class="btn-line-under" href="{url entity='module' name='stproductcomments' controller='mycomments'}" title="{l s='Back to my comments' d='Shop.Theme.Transformer'}" rel="nofollow"><!-- <i class="fto-left fto_mar_lr2"></i> -->{l s='Back to my comments' d='Shop.Theme.Transformer'}</a>
  </div>
{/block}