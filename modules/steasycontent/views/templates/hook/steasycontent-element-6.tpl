...
<div id="easy_products_container_{$element.id_st_easy_content_element}" class="easy_products_container products_container" >
...
<section class="products_section">
    {if isset($element.products) && $element.products && count($element.products)}
        ...
        {if !$element.st_grid}
            ...
            lazy_load=$element.st_lazy
            direction_nav=$element.st_direction_nav
            br_direction_nav=$element.st_direction_nav
            control_nav=$element.st_control_nav
            br_control_nav=$element.st_control_nav
            ...
            pro_per_rec_fw=$pro_per_fw
            pro_per_rec_xxl=$pro_per_xxl
            pro_per_rec_xl=$pro_per_xl
            pro_per_rec_lg=$pro_per_lg
            pro_per_rec_md=$pro_per_md
            pro_per_rec_sm=$pro_per_sm
            pro_per_rec_xs=$pro_per_xs
            }
