...
<div class="stsocial_block {if isset($sub_column.st_icon_align)} text-{$sub_column.st_icon_align} {/if} {if isset($sub_column.st_icon_mobile_align) && $sub_column.st_icon_mobile_align} text-md-{$sub_column.st_icon_mobile_align} {/if}">  
   {if isset($sub_column.st_el_header) && $sub_column.st_el_header && $sub_column.st_title_position != 3} 
  <div class="title_block flex_container title_align_{(int)$sub_column.st_title_position} title_style_{(int)$sttheme.heading_style}" sttext_item_header">
                            <div class="flex_child title_flex_left"></div>
                            <div class="title_block_inner">{$sub_column.st_el_header}</div>
...
{foreach $sub_column['elements'] as $element}
	<li class="{if $element.st_el_hide_on_mobile == 1} hidden-md-down {elseif $element.st_el_hide_on_mobile == 2} hidden-lg-up {/if}">
		<a href="{if $element.st_el_url}{$element.st_el_url}{else}#{/if}" id="stsocial_item_{$element.id_st_easy_content_element}" rel="nofollow" title="{if $element.st_el_header}{$element.st_el_header}{else}{$element.st_el_icon}{/if}" {if isset($sub_column.st_new_window) && $sub_column.st_new_window} target="_blank" {/if} class="flex_box">
