...
{if isset($groups)}
    {foreach $groups as $group}
        ...
        {if $group.is_full_width}<div id="banner_container_{$group.id_st_banner_group}{if isset($st_time)}{$st_time}{/if}" class="banner_container_{$group.id_st_banner_group} {if $group.classpluslink}privat_banner_{$group.classpluslink}{/if} banner_container full_container {if $group.hide_on_mobile == 1} hidden-md-down {elseif $group.hide_on_mobile == 2} hidden-lg-up {/if} block {if $group.mpfour} video_bg_block {/if} {if $group.baner_coneat_page == 1}one_page_desc{/if} {if $group.baner_coneat_filtr == 0}hide_filter_page{/if} " {$smarty.capture.parallax_param nofilter} {$smarty.capture.video_background nofilter}>{if !$group.stretched}<div class="container">{/if}{/if}
            <div id="st_banner_{$group.id_st_banner_group}{if isset($st_time)}{$st_time}{/if}" class="st_banner_{$group.id_st_banner_group} {if $group.classpluslink}privat_banner_{$group.classpluslink}{/if} st_banner_row st_banner_{$style} {if !$group.is_full_width} block {/if} {if $group.hide_on_mobile == 1} hidden-md-down {elseif $group.hide_on_mobile == 2} hidden-lg-up {/if}{if $group['hover_effect']} hover_effect_{$group['hover_effect']} {/if} {if isset($group.is_column) && $group.is_column} column_block {/if} {if $group.mpfour} video_bg_block {/if} {if $group.baner_coneat_page == 1 && !$group.is_full_width}one_page_desc{/if} {if $group.baner_coneat_filtr == 0 && !$group.is_full_width}hide_filter_page{/if} " {if !$group.is_full_width}{$smarty.capture.parallax_param nofilter} {$smarty.capture.video_background nofilter}{/if}>
