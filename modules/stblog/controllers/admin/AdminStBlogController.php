...
class AdminStBlogController extends ModuleAdminController
{
    ...
    {
        return '<a href="'.$this->context->link->getModuleLink('stblog', 'article', array('id_st_blog'=>(int)$id,'preview'=>1, 'rewrite' => $value)).'" target="_blank" class="view">
    ...
    public function postCover($obj)
    {
        ...
        {
            $old_images = StBlogImageClass::getImageIdByType($obj->id, 1);
        ...
        /*
            iWeb - 2019-09-27
        */
        if (isset($_FILES['image_2']['tmp_name']) && !empty($_FILES['image_2']['tmp_name']))
        {
            $old_images = StBlogImageClass::getImageIdByType($obj->id, 3);
            foreach($old_images AS $old)
            {
                $img = new StBlogImageClass('3', $old);
                $img->setShopList($img->getAssociatedShops())->delete();
            }
            $image = new StBlogImageClass('3');
            $return = $image->setShopList($obj->getAssociatedShops())->save('image_2');    
        }
	...
	public function renderForm()
	{
        ...
        */
        ...
        if ($this->object->id)
        {
            $cover_2 = $this->object->getCoverUrl('small', 3);
            if ($cover_2 && file_exists(_PS_ROOT_DIR_.$cover_2))
            {
                $cover_2 = '<img src="'.$cover_2.'" /><p><a class="btn btn-default st_blog_cover_image" href="javascript:;" data-id="'.(int)$this->object->id.'" data-type="3" data-token="'.Tools::getValue('token').'"><i class="icon-trash"></i> Delete</a></p>';
            }
            else
                $cover_2 = false;
            $this->object->date_add = date('Y-m-d', strtotime($this->object->date_add));
		...
		$this->fields_form[0]['form'] = array(
			...
			'input' => array(
				...
				array(
					'type' => 'radio',
					'label' => $this->trans('Whether to display the article cover on the category page and the blog home page:', array(), 'Modules.Stblog.Admin'),
					'name' => 'img_on_category',
					'required' => false,
					'class' => 't',
                    'default_value' => 1,
					'values' => array(
						array(
							'id' => 'img_on_category_1',
							'value' => 1,
							'label' => $this->trans('Yes', array(), 'Modules.Stblog.Admin')
						),
						array(
							'id' => 'img_on_category_2',
							'value' => 2,
							'label' => $this->trans('The second cover of the article', array(), 'Modules.Stblog.Admin')
						),
						array(
							'id' => 'img_on_category_3',
							'value' => 3,
							'label' => $this->trans('No', array(), 'Modules.Stblog.Admin')
						)
					),
					
					'desc' => $this->trans('Always, even as in the article is set not to show.', array(), 'Modules.Stblog.Admin')
                ...
                */
                array(
                    'type' => 'file',
                    'label' => $this->trans('Cover image another:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'image_2',
                    'image' => $cover_2,
                ),
                array(
                ...
                array(
                    ...
                    'id' => 'a_cancel',
					'label' => '',
					'name' => '<a class="btn btn-default fixed-width-md" href="'.self::$currentIndex.'&token='.Tools::getValue('token').'"><i class="icon-arrow-left"></i> '.$this->trans('Back to list', array(), 'Admin.Theme.Transformer').'</a>'.
		...
		$this->fields_form[11]['form'] = array(
			'legend' => array(
				'title' => $this->trans('Graphic layout of the article', array(), 'Admin.Theme.Transformer')
			),
			...
			'input' => array(
		    	...
		    	array(
					'type' => 'radio',
		        	'label' => $this->trans('Article content layout:', array(), 'Admin.Theme.Transformer'),
					'name' => 'article_blog_top',
					'required' => false,
					'default_value' => 3,
					'values' => array(
						 array(
							'id' => 'article_blog_top_0',
							'value' => 0,
							'label' => $this->trans('Default', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_top_1',
							'value' => 1,
							'label' => $this->trans('No photo, photo gallery, video', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_top_2',
							'value' => 2,
							'label' => $this->trans('No photo, photo gallery, video + two column content', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_top_3',
							'value' => 3,
							'label' => $this->trans('Photo, photo gallery, video on the entire width of the article', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_top_4',
							'value' => 4,
							'label' => $this->trans('Photo, photo gallery, video on the entire width of the article + two column content', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_top_5',
							'value' => 5,
							'label' => $this->trans('Photo, photo gallery, half width video + article title on the right', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_top_6',
							'value' => 6,
							'label' => $this->trans('Photo, photo gallery, half width video + article title on the right + two column content', array(), 'Admin.Theme.Transformer')),					
					),
				),
				...
				array(
					'type' => 'radio',
					'label' => $this->trans('Author of the article:', array(), 'Admin.Theme.Transformer'),
					'name' => 'article_blog_autor',
					'required' => false,
					'default_value' => 0,
					'values' => array(
						array(
							'id' => 'article_blog_autor_0',
							'value' => 0,
							'label' => $this->trans('Default', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_autor_1',
							'value' => 1,
							'label' => $this->trans('Yes', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_autor_2',
							'value' => 2,
				...
				array(
					'type' => 'radio',
					'label' => $this->trans('Date of the article:', array(), 'Admin.Theme.Transformer'),
					'name' => 'article_blog_date',
					'required' => false,
					'default_value' => 0,
					'values' => array(
						array(
							'id' => 'article_blog_date_0',
							'value' => 0,
							'label' => $this->trans('Default', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_date_1',
							'value' => 1,
							'label' => $this->trans('Yes', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_date_2',
							'value' => 2,
							'label' => $this->trans('No', array(), 'Admin.Theme.Transformer')),
				...
				array(
					'type' => 'radio',
					'label' => $this->trans('Date of the article icon:', array(), 'Admin.Theme.Transformer'),
					'name' => 'article_blog_date_icon',
					'required' => false,
					'default_value' => 0,
					'values' => array(
						array(
							'id' => 'article_blog_date_icon_0',
							'value' => 0,
							'label' => $this->trans('Default', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_date_icon_1',
							'value' => 1,
							'label' => $this->trans('Yes', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_date_icon_2',
							'value' => 2,
							'label' => $this->trans('No', array(), 'Admin.Theme.Transformer')),
				...
				array(
					'type' => 'radio',
					'label' => $this->trans('Number of article views:', array(), 'Admin.Theme.Transformer'),
					'name' => 'article_blog_view_art',
					'required' => false,
					'default_value' => 0,
					'values' => array(
						array(
							'id' => 'article_blog_view_art_0',
							'value' => 0,
							'label' => $this->trans('Default', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_view_art_1',
							'value' => 1,
							'label' => $this->trans('Yes', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_view_art_2',
							'value' => 2,
							'label' => $this->trans('No', array(), 'Admin.Theme.Transformer')),
				...
				array(
					'type' => 'radio',
					'label' => $this->trans('Ability to add to favorites:', array(), 'Admin.Theme.Transformer'),
					'name' => 'article_blog_loved',
					'required' => false,
					'default_value' => 0,
					'values' => array(
						array(
							'id' => 'article_blog_loved_0',
							'value' => 0,
							'label' => $this->trans('Default', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_loved_1',
							'value' => 1,
							'label' => $this->trans('Yes', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_loved_2',
							'value' => 2,
							'label' => $this->trans('No', array(), 'Admin.Theme.Transformer')),
				...
				array(
					'type' => 'radio',
					'label' => $this->trans('Category of the article:', array(), 'Admin.Theme.Transformer'),
					'name' => 'article_blog_category',
					'required' => false,
					'default_value' => 0,
					'values' => array(
						array(
							'id' => 'article_blog_category_0',
							'value' => 0,
							'label' => $this->trans('Default', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_category_1',
							'value' => 1,
							'label' => $this->trans('Yes', array(), 'Admin.Theme.Transformer')),
						array(
							'id' => 'article_blog_category_2',
							'value' => 2,
							'label' => $this->trans('No', array(), 'Admin.Theme.Transformer')),
        ...
        if ($products)
            foreach($products AS &$product)
                $true_products[] = array('id_product' => $product['id_product'], 'name' => $product['id_product'].' - '.$product['name']);
    ...
    public function ajaxProcessDeleteCoverImage()
	{
		...
		$image = StBlogImageClass::getCoverImage((int)Tools::getValue('id_st_blog'), Context::getContext()->language->id, $type);
        if ($image)
        {
            $image = new StBlogImageClass($type, (int)$image['id_st_blog_image']);
    		if ($image->setShopList($image->getAssociatedShops())->delete())
            {
                $result['r'] = true;
