	...
	<div class="form-group">
		<label class="control-label col-lg-{if $gallery.id_st_blog}3{else}4{/if} file_upload_label">
			...
			<span class="label-tooltip" data-toggle="tooltip"
				...
				{if $gallery.id_st_blog}{l s='Add a new image to this blog:'  d='Admin.Theme.Transformer'}{else}{l s='You must save the blog before adding gallery.'  d='Admin.Theme.Transformer'}{/if}
			</span>
		</label>
		<div class="col-lg-9">
...
<table class="table tableDnD" id="imageTable">
	<thead>
		<tr class="nodrag nodrop"> 
			<th class="fixed-width-sm"><span class="title_box">{l s='Image'  d='Admin.Theme.Transformer'}</span></th>
			<th class="center fixed-width-xs"><span class="title_box">{l s='Position'  d='Admin.Theme.Transformer'}</span></th>
			{if $gallery.shops}
	...
	<tr id="image_id">
		...
		<td class="center">
			<a href="#" class="delete_gallery_image pull-right btn btn-default" >
					<i class="icon-trash"></i> {l s='Delete'  d='Admin.Theme.Transformer'}
			</a>
		</td>
	</tr>
</table>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$(document).on('click', '.delete_gallery_image', function(e)
		{
			...
			if (confirm("{/literal}{l s='Are you sure?' d='Admin.Theme.Transformer' js=1}{literal}"))
			doAdminAjax({
