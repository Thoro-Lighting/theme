...
*}
     ...
     {if ($p_c.display_image != 0) && ((isset($blog.cover) && $blog.cover) || $blog.cover_2.links.large.image) }
          {if $blog.type==1}
              ...
              <div class="blog_image" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
                ...
                {if (!empty($blog.cover_2.links.large.image) && ($p_c.display_image == 3 || ($blog.img_on_category == 2 && $p_c.display_image == 1)))}
