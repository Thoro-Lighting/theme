...
<div class="block_blog {if isset($classname)} {$classname} {/if} mosaic">
    <div class="pro_outer_box pro_second_absolute {if $p_c.img_text == 1}row{/if} {if (isset($for_w) && $for_w=='category' && $category_layouts==2) || (isset($display_as_grid) && ($display_as_grid==2 || $display_as_grid==4))} blog_lr clearfix {/if}">
    ...
    <div class="pro_first_box {if $p_c.img_text == 1}col-md-{$p_c.items_img}{/if}">
        ...
        {include file='module:stblog/views/templates/slider/post-cover-mosaic.tpl' show_video=1}
    {/if}
