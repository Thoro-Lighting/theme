...
*}
        ...
        {if isset($blog.galleries) && count($blog.galleries)}
            <div class="swiper-container tm_gallery swiper-button-lr swiper-navigation-circle swiper-small-button" data-lazyload="{$is_lazy}" {if $sttheme.is_rtl} dir="rtl" {/if} {if !isset($no_google_rich_snippets) || !$no_google_rich_snippets} itemprop="image" itemscope itemtype="https://schema.org/ImageObject"{/if}>
