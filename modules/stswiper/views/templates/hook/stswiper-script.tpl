...
//<![CDATA[
        ...
        swiper_options.push({
            ...
            {if $slides.prev_next}
                nextButton: '#st_swiper_{$slides.id_st_swiper_group}{if isset($st_time)}{$st_time}{/if} .swiper-button-next',
                prevButton: '#st_swiper_{$slides.id_st_swiper_group}{if isset($st_time)}{$st_time}{/if} .swiper-button-prev',
            {/if}
            {if $slides.pag_nav}
