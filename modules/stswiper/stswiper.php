...
class StSwiper extends Module implements WidgetInterface
{
	...
	public function installDb()
	{
		...
		$return &= (bool)Db::getInstance()->execute('
			CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'st_swiper_group` (
                ...
                `swip_coneat_page` tinyint(1) unsigned NOT NULL DEFAULT 0,
                `swip_coneat_filtr` tinyint(1) unsigned NOT NULL DEFAULT 1,
	...
	{        
		...
		$this->fields_form[0]['form'] = array(
			...
			'name' => 'swip_coneat_filtr',
			'is_bool' => true,
            'default_value' => 1,
			'values' => array(
				array(
					'id' => 'swip_coneat_filtr_on',
					'value' => 1,
					'label' => $this->getTranslator()->trans('Yes', array(), 'Admin.Theme.Transformer')),
				array(
					'id' => 'swip_coneat_filtr_off',
					'value' => 0,
					'label' => $this->getTranslator()->trans('No', array(), 'Admin.Theme.Transformer')),
			),
			'validation' => 'isBool',
	...
	protected function initFormSlide($isbanner=0)
	{
		...
		$this->fields_form_slide[0]['form'] = array(
			...
			'input' => array(
                array(
					'type' => 'select',
        			'label' => $this->getTranslator()->trans('Choose a group:', array(), 'Admin.Theme.Transformer'),
    ...
    public function renderWidget($hookName = null, array $configuration = [])
    {
        ...
        $cache_id = implode('-',$identify).(string)$id_st_swiper_group;
