...
{if $stins_for_css && $stins_for_css|@count}
	...
	{strip}
		...
		{if $in['title_border_color']} {$prefix} .title_block{literal}{border-bottom-color:{/literal} {$in['title_border_color']};} {/if} 
		{if $in['title_border_color_h']} {$prefix} .title_block_inner{literal}{border-bottom-color:{/literal} {$in['title_border_color_h']};} {/if} 
		...
		{if $in['direction_disabled_bg']} {$prefix} .owl-theme.owl-navigation-tr .owl-controls .owl-buttons div.disabled,{$prefix} .owl-theme.owl-navigation-tr .owl-controls .owl-buttons div.disabled:hover, {$prefix} .owl-theme.owl-navigation-lr.owl-navigation-rectangle .owl-controls .owl-buttons div.disabled, {$prefix} .owl-theme.owl-navigation-lr.owl-navigation-circle .owl-controls .owl-buttons div.disabled,{$prefix} .owl-theme.owl-navigation-lr.owl-navigation-rectangle .owl-controls .owl-buttons div.disabled:hover, {$prefix} .owl-theme.owl-navigation-lr.owl-navigation-circle .owl-controls .owl-buttons div.disabled:hover{literal}{background-color:{/literal}{$in['direction_disabled_bg']};} {/if} 
