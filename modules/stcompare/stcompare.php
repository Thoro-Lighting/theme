    ...
    private function initPages()
    {
        $this->_items = array(
                ...
                array(
                    'id' => 'fly_icone',
                    'val' => '256',
                    'name' => $this->getTranslator()->trans('Fly icone', array(), 'Admin.Theme.Transformer')
                ),
                
                array(
                    'id' => 'stickers_icone',
                    'val' => '512',
                    'name' => $this->getTranslator()->trans('Stickers - icons', array(), 'Admin.Theme.Transformer')
                ),
                
                array(
                    'id' => 'loved_icone',
                    'val' => '1024',
                    'name' => $this->getTranslator()->trans('Loved products', array(), 'Admin.Theme.Transformer')
                ),
                
                array(
                    'id' => 'wishlist_icone',
                    'val' => '2048',
                    'name' => $this->getTranslator()->trans('Wishlist products', array(), 'Admin.Theme.Transformer')
                ),
                
                array(
                    'id' => 'countdown_compare',
                    'val' => '4096',
                    'name' => $this->getTranslator()->trans('Countdown promotion', array(), 'Admin.Theme.Transformer')
                ),
