...
class StCurrencyselector extends Module implements WidgetInterface
{
    ...
    private function initHookArray()
    {
        $this->_hooks = array(
            'Hooks' => array(
                ...
                array(
                    'id' => 'displayMobileNavLancur',
                    'val' => '1',
                    'name' => $this->getTranslator()->trans('Sidebar change Currency', array(), 'Admin.Theme.Transformer'),
                ),
            )
        );
    }
	...
	public function install()
	{
        ...
        Configuration::updateValue('ST_CURRENCIES_TEXT', 0) &&
        Configuration::updateValue('ST_CURRENCIES_STYLE', 0);
        Configuration::updateValue('ST_CURRENCIES_LABEL_SIDEBAR', 0) &&
        Configuration::updateValue('ST_CURRENCIES_TEXT_SIDEBAR', 0) &&
        Configuration::updateValue('ST_CURRENCIES_STYLE_SIDEBAR', 0);
	}
    ...
    protected function initFieldsForm()
    {
		$this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                array(
                 ...
                 array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Currencies label mobile:', array(), 'Modules.Stcurrencyselector.Admin'),
                    'name' => 'currencies_label_mobile',
                    'default_value' => 1,
                    'values' => array(
                        array(
                            'id' => 'currencies_label_mobile_both',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Sign + code', array(), 'Modules.Stcurrencyselector.Admin')),
                        array(
                            'id' => 'currencies_label_mobile_name',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Code', array(), 'Modules.Stcurrencyselector.Admin')),
                        array(
                            'id' => 'currencies_label_mobile_flag',
                            'value' => 2,
                            'label' => $this->getTranslator()->trans('Sign', array(), 'Modules.Stcurrencyselector.Admin')),
                    ),
                    'validation' => 'isUnsignedInt',
                 ...
                 array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Currencies text:', array(), 'Modules.Stcurrencyselector.Admin'),
                    'name' => 'currencies_text',
                    'default_value' => 1,
                    'values' => array(
                        array(
                            'id' => 'currencies_text_0',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('No', array(), 'Modules.Stcurrencyselector.Admin')),
                        array(
                            'id' => 'currencies_text_1',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Yes', array(), 'Modules.Stcurrencyselector.Admin')),
		...
		$this->fields_form[2]['form'] = array(
			'legend' => array(
				'title' => $this->getTranslator()->trans('Settings if the selection is set in the pull-out box "sidebar"', array(), 'Admin.Theme.Transformer'),
                'icon' => 'icon-cogs'
			),
            'input' => array(
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Currencies label:', array(), 'Modules.Stcurrencyselector.Admin'),
                    'name' => 'currencies_label_sidebar',
                    'default_value' => 1,
                    'values' => array(
                        array(
                            'id' => 'currencies_label_sidebar_both',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Sign + code', array(), 'Modules.Stcurrencyselector.Admin')),
                        array(
                            'id' => 'currencies_label_sidebar_name',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Code', array(), 'Modules.Stcurrencyselector.Admin')),
                        array(
                            'id' => 'currencies_label_sidebar_flag',
                            'value' => 2,
                            'label' => $this->getTranslator()->trans('Sign', array(), 'Modules.Stcurrencyselector.Admin')),
                    ),
                    'validation' => 'isUnsignedInt',
                 ...
                 array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Currencies text:', array(), 'Modules.Stcurrencyselector.Admin'),
                    'name' => 'currencies_text_sidebar',
                    'default_value' => 1,
                    'values' => array(
                        array(
                            'id' => 'currencies_text_sidebar_0',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('No', array(), 'Modules.Stcurrencyselector.Admin')),
                        array(
                            'id' => 'currencies_text_sidebar_1',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Yes', array(), 'Modules.Stcurrencyselector.Admin')),
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('How to display:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'currencies_style_sidebar',
                    'default_value' => 1,
                    'values' => array(
                        array(
                            'id' => 'currencies_style_sidebar_0',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('A drop-down list', array(), 'Modules.Stcurrencyselector.Admin')),
                        array(
                            'id' => 'currencies_style_sidebar_1',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Buttons', array(), 'Admin.Theme.Transformer')),
                    ),
                    'validation' => 'isUnsignedInt',
    ...
    private function getConfigFieldsValues()
    {
        $fields_values = array(
            ...
            'currencies_label_mobile' => Configuration::get('ST_CURRENCIES_LABEL_MOBILE'),
            'currencies_style' => Configuration::get('ST_CURRENCIES_STYLE'),
            'currencies_text' => Configuration::get('ST_CURRENCIES_TEXT'),
            'currencies_label_sidebar' => Configuration::get('ST_CURRENCIES_LABEL_SIDEBAR'),
            'currencies_style_sidebar' => Configuration::get('ST_CURRENCIES_STYLE_SIDEBAR'),
            'currencies_text_sidebar' => Configuration::get('ST_CURRENCIES_TEXT_SIDEBAR'),
        );
    ...
    public function getWidgetVariables($hookName, array $configuration)
    {
        ...
        return [
            ...
            'display_sign_mobile' => Configuration::get('ST_CURRENCIES_LABEL_MOBILE'),
    ...
    public function hookDisplayMobileNavLancur($params) {

        $this->smarty->assign($this->getWidgetVariables('displayMobileNavLancur', array()));

        return $this->display(__FILE__, 'stcurrencyselector-sidebar.tpl');
    }
}
