...
{if !isset($currencies_style) || !$currencies_style}
	...
	{assign var='currencies_text' value=Configuration::get('ST_CURRENCIES_TEXT')}
	
	{if $currencies_text == 1}<span class="choose_lc header_item">{l s='Currency' d='Shop.Theme.Transformer'}:</span>{/if}
