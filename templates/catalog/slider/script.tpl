    ...
    //<![CDATA[
        ...
        swiper_options.push({
            ...
            {/if}
                 ...
                 paginationType: {if $br_control_nav==2}'bullets'{elseif $br_control_nav==3}'progress'{else}'bullets'{/if}, //A bug of swiper, this should be 'custom' when nav==4
                     {if $br_control_nav==4}
                     {literal}
        ...
        {else}
            ...
            spaceBetween: {(int)$spacing_between}, //new
                {if ((isset($homeverybottom) && $homeverybottom) || $sttheme.responsive_max==3) && $pro_per_rec_fw}
                    {assign var='slidesPerView' value=$pro_per_rec_fw}
                {else}
                    {if $sttheme.responsive_max==2}
                        {assign var='slidesPerView' value=$pro_per_rec_xxl}
                    {elseif $sttheme.responsive_max>=1}
                        {assign var='slidesPerView' value=$pro_per_rec_xl}
                    {else}
                        {assign var='slidesPerView' value=$pro_per_rec_lg}
                    {/if}
                {/if}
            ...
            breakpoints: {
                {/literal}
                {if ((isset($homeverybottom) && $homeverybottom) || $sttheme.responsive_max==3) && $pro_per_rec_fw}
                {if $sttheme.responsive_max==2}1600{elseif $sttheme.responsive_max==1}1440{else}1200{/if}{literal}: {slidesPerView: {/literal}{$pro_per_rec_xxl|default:3}{if $slider_move==1}, slidesPerGroup: {$pro_per_rec_xxl|default:3}{/if}{literal} },{/literal}
                {/if}
                {if $sttheme.responsive_max==2}{literal}1440: {slidesPerView: {/literal}{$pro_per_rec_xl|default:3}{if $slider_move==1}, slidesPerGroup: {$pro_per_rec_xl|default:3}{/if}{literal} },{/literal}{/if}
                {if $sttheme.responsive_max>=1}{literal}1200: {slidesPerView: {/literal}{$pro_per_rec_lg|default:2}{if $slider_move==1}, slidesPerGroup: {$pro_per_rec_lg|default:2}{/if}{literal} },{/literal}{/if}
                992: {literal}{spaceBetween:30,slidesPerView: {/literal}{$pro_per_rec_md|default:4}{if $slider_move==1}, slidesPerGroup: {$pro_per_rec_md|default:4}{/if}{literal} },{/literal}
                768: {literal}{spaceBetween:30,slidesPerView: {/literal}{$pro_per_rec_sm|default:3}{if $slider_move==1}, slidesPerGroup: {$pro_per_rec_sm|default:3}{/if}{literal} },{/literal}
                480: {literal}{spaceBetween:30,slidesPerView: {/literal}{$pro_per_rec_xs|default:2}{if $slider_move==1}, slidesPerGroup: {$pro_per_rec_xs|default:2}{/if}{literal} }
            },
            {/literal}
            {/if}
        ...
        {/if}
            ...
            {else}
                ...
                spaceBetween: {(int)$spacing_between}, //new
                    ...
                    {/if}
                slidesPerView: {if $slidesPerView}{$slidesPerView}{else}1{/if},
                {if $slider_move==1}slidesPerGroup: {if $slidesPerView}{$slidesPerView}{else}4{/if},{/if}
                {if $sttheme.responsive && !$sttheme.version_switching}
                {literal}
                breakpoints: {
                    {/literal}
                    ...
                    992: {literal}{spaceBetween:30,slidesPerView: {/literal}{$pro_per_md|default:4}{if $slider_move==1}, slidesPerGroup: {$pro_per_md|default:4}{/if}{literal} },{/literal}
                    768: {literal}{spaceBetween:30,slidesPerView: {/literal}{$pro_per_sm|default:3}{if $slider_move==1}, slidesPerGroup: {$pro_per_sm|default:3}{/if}{literal} },{/literal}
                    480: {literal}{spaceBetween:30,slidesPerView: {/literal}{$pro_per_xs|default:2}{if $slider_move==1}, slidesPerGroup: {$pro_per_xs|default:2}{/if}{literal} }
                },
                {/literal}
                {/if}
            ...
            onInit : function (swiper) {
                ...
                {/literal}
                {if $direction_nav OR $br_direction_nav}
                {literal}
