...
{block name='page_title'}
    <h6 class="page_heading"><a class="backtoaccount" href="{$urls.pages.my_account}"><i class="fto-angle-double-left side_close_left"></i></a>{l s='Order history' d='Shop.Theme.Customeraccount'}</h6>
{/block}
      ...
      <tbody>
        {foreach from=$orders item=order}
          <tr>
            ...
            <td class="text-right">{$order.totals.total.value nofilter}</td>
      ...
      {foreach from=$orders item=order}
        <div class="order line_item flex_box">
            <div class="flex_child">
              ...
              <div class="date">{$order.details.order_date nofilter}</div>
              <div class="total">{$order.totals.total.value nofilter}</div>
            ...
            <div class="text-right">
              <div class="status">
                ...
                >
                  ...
                  <a class="btn-line mr-2" href="{$order.details.details_url}" data-link-action="view-order-details" title="{l s='Details' d='Shop.Theme.Customeraccount'}">
                    {l s='Details' d='Shop.Theme.Customeraccount'}
                  </a>
                {if $order.details.reorder_url}
                    <a class="btn-line mr-2" href="{$order.details.reorder_url}" title="{l s='Reorder' d='Shop.Theme.Actions'}" class="mar_l6">
