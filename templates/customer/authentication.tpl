                  ...
                  {block name='page_content'}
                    ...
                    <div class="row">
                        ...
                        {block name='new_customers_container'}
                          <div class="col-lg-{12-$auth_login_width} {if $sttheme.auth_layout == 1}register_two_columns{/if}">
                            <section id="create_account_block" class="from_blcok block login_form_block">
                              {if $sttheme.auth_heading_align!=3}<h3
                                ...
                                {l s='New customers?' d='Shop.Theme.Transformer'}</h3>{/if}
                              ...
                              <footer class="form-footer">
                                <a class="btn btn-primary btn-large js-btn-active {if $arrow_buttons}btn_arrow{/if} btn-spin btn-full-width"
                                  href="{$urls.pages.register}" data-link-action="display-register-form" id="SubmitCreate"
                                  rel="nofollow">
                      ...
                      {block name='login_form_container'}
                          <section id="login_form_block"
                            class="from_blcok block login_form_block {if !$sttheme.auth_layout} one_column_login {/if}">
                            {if $sttheme.auth_layout}
                              {if $sttheme.auth_heading_align!=3}<h3
                                  class="page_heading {if $sttheme.auth_heading_align==1} text-2 {elseif $sttheme.auth_heading_align==2} text-3 {else} text-1 {/if}">
                                {l s='Registered customers' d='Shop.Theme.Transformer'}</h3>
                              {/if}
                            {/if}
                            ...
                            <div class="sidebar_auth_form">
                              ...
                              <footer class="form-footer text-center">
                                <p class="footer-register">
                                  {l s='You are a new user?' d='Shop.Theme.Transformer'}
